...
from US19test import cousins_married_check #Takes in familiesDF
from US20test import aunt_uncle_married_check #Takes in familiesDF
...
errors += cousins_married_check(families)
errors += aunt_uncle_married_check(families)
